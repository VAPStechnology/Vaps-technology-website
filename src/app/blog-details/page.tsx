...
export const metadata: Metadata = {
  title: "Blog Details Page | VAPS technology",
              ...
              <div>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    In today’s fast-paced digital world, businesses and startups
                    alike need robust and scalable applications to succeed.
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Full-stack development has become the go-to approach for
                    building comprehensive solutions that cover both the
                    front-end (what users see) and the back-end (what powers the
                    application). In this blog, we’ll explore why full-stack
                    development is critical, what it involves, and how it drives
                    the success of modern digital platforms.
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    What is Full-Stack Development?
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Full-stack development refers to the development of both the
                    front-end and back-end portions of a web or mobile
                    application. A full-stack developer is skilled in all layers
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-center text-base font-medium italic text-body-color">
                      Full-stack development involves a wide array of tools and
                      technologies. Some of the most commonly used technologies
                      include:
                      <ul className=" flex items-center justify-center text-blue-400">
                      <li className="mb-2 text-base font-mediums sm:text-lg lg:text-base">
                      ...
                      <li className="mb-2 text-base font-mediums sm:text-lg lg:text-base">
                        APIs and Version Control: REST, GraphQL, Git, GitHub
                      </li>
                      </ul>
                    </p>
